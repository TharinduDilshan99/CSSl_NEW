...
interface HeaderSort1Props {
    column: HeaderGroup<{}>;
    sort?: boolean;
}

export const HeaderSort1 = ({ column, sort }: HeaderSort1Props) => {
...
interface TablePagination1Props {
...
export const TablePagination1 = ({ gotoPage, rows, setPageSize, pageSize, pageIndex }: TablePagination1Props) => {
...
export const TableRowSelection1 = ({ selected }: { selected: number }) => (
    <>
        {selected > 0 && (
            <Chip
                size="small"
...
interface SortingSelect1Props {
    sortBy: string;
    setSortBy: (sortBy: SortingRule<{}>[]) => void;
    allColumns: ColumnInstance<{}>[];
}

export const SortingSelect1 = ({ sortBy, setSortBy, allColumns }: SortingSelect1Props) => {
