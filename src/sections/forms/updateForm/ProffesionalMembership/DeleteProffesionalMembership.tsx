...
import { DeleteFilled } from '@ant-design/icons';
import { dispatch } from 'store';
import { deleteProffesionalQualification } from 'store/reducers/proffesional-membership';
...
export default function DeleteProffesionalQualification({ title, open, handleClose, id }: Props) {
    return (
        <Dialog
            open={open}
            onClose={() => handleClose(false)}
            ...
            <DialogContent sx={{ mt: 2, my: 1 }}>
                <Stack alignItems="center" spacing={3.5}>
                    ...
                    <Stack direction="row" spacing={2} sx={{ width: 1 }}>
                        ...
                        <Button fullWidth color="error" variant="contained" onClick={() => {
                            dispatch(deleteProffesionalQualification(id!))
                            handleClose(true)
                        }} autoFocus>
                            Delete
                        </Button>
