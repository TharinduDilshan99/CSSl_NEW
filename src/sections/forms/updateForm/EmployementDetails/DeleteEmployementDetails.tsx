...
import { DeleteFilled } from '@ant-design/icons';
import { dispatch } from 'store';
import { deleteEmploymentDetails } from 'store/reducers/employment-details';
...
export default function DeleteEmploymentDetails({ title, open, handleClose, id }: Props) {
    return (
        <Dialog
            open={open}
            onClose={() => handleClose(false)}
            ...
            <DialogContent sx={{ mt: 2, my: 1 }}>
                <Stack alignItems="center" spacing={3.5}>
                    ...
                    <Stack direction="row" spacing={2} sx={{ width: 1 }}>
                        ...
                        <Button fullWidth color="error" variant="contained" onClick={() => {
                            dispatch(deleteEmploymentDetails(id!))
                            handleClose(true)
                        }} autoFocus>
                            Delete
                        </Button>
