...
function createData(invoice_no: number, date: Date, protein: number): Data {
    return { invoice_no, date, protein };
}

const rows = [
    createData(4001, new Date('2023-05-01'), 40570),
    createData(3001, new Date('2023-06-17'), 30570)
];
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell align="left">
                                        <NumericFormat value={row.protein} displayType="text" thousandSeparator prefix="Rs." />
                                    </TableCell>
                                </TableRow>
                            );
                        })}
